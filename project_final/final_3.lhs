...
>	      eIf (EIsNil (EVbl (EV "xs")))
>		eZero
>		(eInc `EApp` (EVbl (EV "len") `EApp`
>		        (eTl `EApp` EVbl (EV "xs")))))
>	    (EApp (EVbl (EV "len")) (ELit (LBool True) `ECons`
>		                     (ELit (LBool False) `ECons` ENil)))
...
>                           (EVbl (EV "x"))))
> eMyTest10 = EAbs (EV "x") $ (ELet (EV "a") (ECons (EVbl (EV "x")) ENil)
>                          (ELet (EV "b") (ESnd (EVbl (EV "x")))
>                          (EVbl (EV "a") `ECom` EVbl (EV "b"))))
> 
>
>
> eMyTest1 = EAbs (EV "x") $ (ELet (EV "a") (ECons (EVbl (EV "x")) ENil)
>                            (ELet (EV "b") (ESnd (EVbl (EV "x")))
>                            (EVbl (EV "b") `ECom` EVbl (EV "a"))))
> eMyTest2 = EAbs (EV "x") 
>              (eIf (EIsNil (EVbl (EV "x")))
>                   eZero
>                   (eInc `EApp` (eHd `EApp` (EVbl (EV "x")))))
> eMyTest3 = EAbs (EV "x") 
>              (eIf (EIsNil (EVbl (EV "x")))
>                   ENil 
>                   (eTl `EApp` (eHd `EApp` (EVbl (EV "x")))))
> eMyTest4 = EAbs (EV "x") 
>              (eIf (EIsNil (EVbl (EV "x")))
>                   (eHd `EApp` (EVbl (EV "x")))
>                   (eTl `EApp` (eHd `EApp` (EVbl (EV "x")))))
> eMyTest5 = EAbs (EV "x") 
>              (eIf (EIsNil (eHd `EApp` (EVbl (EV "x"))))
>                   eZero
>                   (eInc `EApp` (eHd `EApp` (EVbl (EV "x")))))
>
> --}
